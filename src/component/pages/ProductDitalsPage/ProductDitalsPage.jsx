...
import RandomCategorySuggest from './RandomCategorySuggest';
import ReacomandProduct from './ReacomandProduct';

import img from "../Home/image/LatestProduct/cloth3.png";
...
{/* ----------------Md axharul creator this---------------md-axharul---------------------------*/}
      ...
      <div className='categoryPage productDitals-Page'>
        <div className='categoryPageParta Product-Diatls-Page-Part '>
    ...
    {/* Middile Products Ditals page Start-------Md Azharul Creator-------Md-Azharul----  */}
                <div className='ProductDitalsMiddleContant'>
                    ...
                    <div className='ProductDetalsPrice'>
                        <h2>$319</h2>
                        <div className='ProductDetalsPriceMiddle'>
                             <span >1254</span>
                             <span >-53%</span>
                        </div>
                    ...
                    <div className='ProductDitalsQuantity'>
                       <span className='brand'>Quantity :</span>
                        <input type='text' readOnly value="-" />
                        <input type='text' readOnly value="01" />
                        <input type='text' readOnly value="+" />
                    </div>
