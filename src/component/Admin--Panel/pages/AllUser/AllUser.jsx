                        ...
                        <table className={"datatable"}>
                            ...
                            {items.length === 0 ? (
                                ...
                                <tr key={item.id} className={'tablerow'}>
                                    ...
                                    <td className={'tabledata'}><Link>{item.category.length > 60 ? item.category.slice(0,60)+"..": item.category} </Link> </td>
                                    ...
                                    <div className=" justify-center  ">
                                        ...
                                        <span onClick={()=>setopen(!open)} to={`/edit-product-admin/${item.id}`} className="  editBtnOpen">Edit
